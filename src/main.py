...
from src.api.endpoints import messages # Router for /v1/messages
from src.core.config import settings # Import the new settings
import logging

# Apply logging configuration at the very beginning
setup_logging()
logger = logging.getLogger(__name__) # Get a logger for this module

app = FastAPI(
    title="Anthropic SDK Facade for LiteLLM",
    version="1.1.0", # Align with Arch Plan
...
# Include API routers
# The architecture specifies only the /v1/messages endpoint for this facade.
app.include_router(messages.router, prefix="/v1") # Added /v1 prefix as per common practice
